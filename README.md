...
[![Video de Demostración de Kambista](https://img.youtube.com/vi/XHKvrTZ9CR4/0.jpg)](https://www.youtube.com/watch?v=XHKvrTZ9CR4)
...
1. Clona el repositorio:
   ```bash
   git clone <https://github.com/romelx23/frontend-app-challenge>
   cd kambista-prueba
   ```
